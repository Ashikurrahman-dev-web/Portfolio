        ...
        >
          <div className="relative">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
                ...
                >
                  <h1 className="text-5xl md:text-6xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-green-500 via-on-background to-cyan-500 bg-[length:200%_auto] animate-shimmer">
                    Ashikur Rahman
                  </h1>
                </motion.div>
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="w-64 h-[2px] bg-surface-container-high rounded-full overflow-hidden">
                        <motion.div 
                            className="h-full bg-green-500 shadow-[0_0_15px_rgba(var(--color-green-500-rgb),0.5)]"
                            initial={{ width: 0 }}
